...
**Upload the file in GCS** and use the URL as attachment in multiple flow.

- [Upload Files on GCS](https://glific.github.io/docs/docs/Integrations/How%20to%20upload%20files%20on%20GCS/)
